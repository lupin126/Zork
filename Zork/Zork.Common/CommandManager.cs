...
namespace Zork
{
    public class CommandManager
    {
        ...
        {
            var commandQuery = from command in mCommands where command.Verbs.Contains(commandString, StringComparer.OrdinalIgnoreCase) select new CommandContext(commandString, command);
        ...
        public void AddCommands(IEnumerable<Command> command) => mCommands.UnionWith(command);
